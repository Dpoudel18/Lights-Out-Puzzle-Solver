...
"""
A python file that can:
-generate an activation matrix for a lights out puzzle
-build a matrix for Gausian and Gause-jordan elimination
-reduce a matrix to it's Row Echelon Form(ref)
-reduce an ref to Reduced ref ( rref)
-Take a matrix and perform operations on it
-Take a tuple of an ref and a list of pivot columns and returns nullity
